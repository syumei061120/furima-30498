...
ActiveRecord::Schema.define(version: 2020_10_06_100723) do
  ...
  create_table "addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchaces_id"], name: "index_addresses_on_purchaces_id"
  end
  ...
  add_foreign_key "addresses", "purchaces", column: "purchaces_id"
